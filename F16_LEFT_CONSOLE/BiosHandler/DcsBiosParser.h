...
#define DCSBIOS_JFS_RUN_MASK       0x0020  // bit 5   LIGHT_JFS_RUN
#define DCSBIOS_HYDRAZN_MASK       0x0040  // bit 6   LIGHT_HYDRAZN
#define DCSBIOS_AIR_MASK           0x0080  // bit 7   LIGHT_AIR
#define DCSBIOS_EPU_RUN_MASK       0x0100  // bit 8   LIGHT_EPU
...
static void dcsBiosOnUpdate(uint16_t addr, uint16_t value) {
  ...
  if (addr == DCSBIOS_ELEC_GRP1_ADDR) {
    ...
    writeElecLed(LI_EPU_HYDRAZN, (value & DCSBIOS_HYDRAZN_MASK));
    writeElecLed(LI_EPU_AIR,     (value & DCSBIOS_AIR_MASK));
    writeElecLed(LI_EPU_RUN,     (value & DCSBIOS_EPU_RUN_MASK));
    writeElecLed(LI_JFS_RUN,     (value & DCSBIOS_JFS_RUN_MASK));
  }
